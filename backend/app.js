...
// Définie des headers HTTP sécurisés en utilisant le package helmet.
// Ajoute aussi une option d'autorisation d'accès des images globales.
app.use(helmet.crossOriginResourcePolicy({ policy: "cross-origin" })); 

// Créer une constante avec la variable d'environement API_KEY.
